...
if __name__ == '__main__':
	...
	subset = ""
        ...
        fname_vld_lbl = os.path.join(args.d, "dt%d%s.%s.final.lbl" % (args.id, subset, "vld"))
        fname_tst_lbl = os.path.join(args.d, "dt%d%s.%s.final.lbl" % (args.id, subset, "tst"))

        fname_vld_pred = os.path.join(args.d, "dt%d%s.%s.final.pred" % (args.id, subset, "vld"))
        fname_tst_pred = os.path.join(args.d, "dt%d%s.%s.final.pred" % (args.id, subset, "tst"))
